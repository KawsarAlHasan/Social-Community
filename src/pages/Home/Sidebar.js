...
const Sidebar = (props) => {
    ...
    return (
        <div className=''>
                ...
                <div className="divider -mt-5" >
                    <div className="avatar">
                        <div className="w-24 rounded-full ring ring-white ring-offset-base-100 ring-offset-2">
                            <img src={sabujImg} alt='no internet' />
                        </div>
                    </div>
                </div>
                <div className=" card place-items-center pt-10">
                    <Link to='/#' className='font-bold'>Sabuj Mahonto</Link>
                    <h2 className='text-gray-400 text-sm font-semibold px-3'>He is best batter in the world</h2>
                </div>
                <div className="divider mb-2"></div>
                <div className="">
                    <Link to='/#' className='hover:bg-base-300 flex justify-between text-gray-400 font-semibold px-4 hover:text-black'> Who viewed your profile <span className='text-primary'>86</span></Link>
                    <Link to='/#' className='hover:bg-base-300 flex justify-between text-gray-400 font-semibold px-4 hover:text-black'>Connections <span className='text-primary'>345</span></Link>
                </div>
                <div className="divider -mb-3 mt-2"></div>
                <div className=" hover:bg-base-300">
                    <Link to="/#" className='flex items-center font-bold my-4'><span className='mx-4 mt-1'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" data-supported-dps="16x16" fill="currentColor" width="16" height="16" focusable="false">
            ...
            {/* secound part */}
            <div className="sm:hidden md:block card w-64 bg-base-100 shadow-xl mt-3 sticky top-20 ">
