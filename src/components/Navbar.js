...
const Navbar = ({ children }) => {
  ...
  const menuItems = (
    <>
      ...
      <li>
        <Link to="/messaging" className="hover:text-gray-900">
          Messaging
        </Link>
      </li>
      <div class="dropdown dropdown-end">
        ...
        <ul
          tabindex="0"
          class=" shadow menu menu-compact dropdown-content bg-base-100"
        >
          <li>
            <Link to="/userProfile" className="hover:text-gray-900">
              Profile
            </Link>
          </li>
          <li>
            <Link to="/setting" className="hover:text-gray-900">
              Settings
            </Link>
          </li>
          <li>
